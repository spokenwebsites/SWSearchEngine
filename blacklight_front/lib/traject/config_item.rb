...
settings do
  ...
  # !-----------------------------------------------------!
  # ! ATENTION !
  # Connections to the Live Solr Core present in this file
  # !-----------------------------------------------------!

  # Where to find solr server to write to
  # provide "solr.url", "https://SOLR_USERNAME:SOLR_PASSWORD@SOLR_SERVER:SOLR_PORT/SOLR_CORE" # For updating the live server
